function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_glcm(TrainingData_File, TestingData_File, Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)
