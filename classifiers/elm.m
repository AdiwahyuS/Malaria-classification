function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy, Sensitivity, Specificity] = elm(TrainingData_File, TestingData_File, Elm_Type, ActivationFunction)
...
%%%%%%%%%% Calculate training & testing classification accuracy
    ...
    for i = 1 : size(T, 2)
        ...
        expectedTraining(:,i) = label_index_expected;
        actualTraining(:,i)   = label_index_actual;
    end
    
    confusionTraining = confusionmat(expectedTraining,actualTraining);
    TrainingAccuracy   = sum(diag(confusionTraining)) / sum(sum(confusionTraining))    
